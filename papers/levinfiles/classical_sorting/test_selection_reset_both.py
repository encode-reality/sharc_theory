"""
Test selection sort where BOTH cells reset their ideal_position to 0 after swap.

Hypothesis: When cells swap, both should get a fresh start at finding their
correct position, not inherit each other's search state.
"""
...
def selection_sort_reset_both(initial_values):
    """
    Selection sort where after swap, BOTH cells reset ideal_position to 0.

    This gives the displaced cell a fresh chance to find its correct position.
    """
    ...
    for timestep in range(MAX_STEPS):
        ...
        for idx in idx_order:
            ...
            if cell.value < neighbor.value and neighbor.can_be_moved():
                ...
                # BOTH cells reset to 0 - fresh start!
                ideal_positions[idx] = 0
                ideal_positions[target] = 0
...
# Test
print("=" * 70)
print("TESTING: BOTH CELLS RESET ideal_position TO 0 AFTER SWAP")
print("=" * 70)
...
for test_array in test_arrays:
    ...
    result, steps, history = selection_sort_reset_both(test_array.copy())
